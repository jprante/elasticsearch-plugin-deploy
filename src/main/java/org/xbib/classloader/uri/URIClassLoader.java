...
public final class URIClassLoader extends URLClassLoader {
    ...
    public URL findResource(final String name) {
        return (URL) AccessController.doPrivileged((PrivilegedAction) () -> finder.findResource(name), acc);
    }
    ...
    public Enumeration<URL> findResources(final String name) throws IOException {
        return (Enumeration<URL>) AccessController.doPrivileged((PrivilegedAction) () -> finder.findResources(name), acc);
    }
